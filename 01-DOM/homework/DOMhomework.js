...
// Tu código acá:
 ...
 created.innerHTML = created.innerHTML + 'Leonel Dufau'
...
function buildToDo(todo, index) {
  // Tu código acá:
  let toDoShell = document.createdElement("div"),
    toDoText = document.createdElement("span"),
    checkbox= document.createdElement("input");
